...
\ \\
\begin{tikzcd}
    & \lbrace B_{\gamma} \vert \gamma \in Morph_{\mathcal{B}}\rbrace \arrow[rd, "\psi^1"] \arrow[ld, "\Phi"'] &                                        \\
...
\begin{center}
\begin{tikzcd}
B_1 \arrow[rd, "\psi^1_{B_1}"] \arrow[rr, "\psi^2_{B_1} = \Phi'_{B_2}"] \arrow[dd, "\gamma"'] \arrow[rrdd, "\Phi_{B_2}"', bend right] &                                      & C_2 \arrow[rd, "q"]  &   \\
                                                                                                                        & C_1 \arrow[ru, "g"'] \arrow[rd, "f"] &                      & C \\
...
\begin{tikzcd}
   ...
   &  &                                                                                            & C_2 \arrow[rd, "q"] \arrow[llld, "\exists ! \varphi"', dashed] &                                               \\
...
\ \\
\begin{tikzcd}
   &  & \mathcal{B} \arrow[lldd, "\psi'"'] \arrow[rrdd, "\psi"] \arrow[d, "\psi^2"] &  &                                               \\
   &  & C_2 \arrow[rrd, "q"] \arrow[lld, "\exists ! \varphi"', dashed]              &  &                                               \\
C' &  &                                                                             &  & C \arrow[llll, "\exists ! \varphi'"', dashed]
\end{tikzcd}
\end{center}
\end{proof}
