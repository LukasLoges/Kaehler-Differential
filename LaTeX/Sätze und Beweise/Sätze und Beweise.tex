...
Sei $R$ ein Körper, somit entspricht die universellen Derivation des Polynomrings $R[x]$ der analytischen Ableitung von Polynomfunktionen. Für $P(x) \in R[x]$ gilt also:
\begin{gather*}
